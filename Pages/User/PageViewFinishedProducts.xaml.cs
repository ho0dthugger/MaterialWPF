...
{
    public partial class PageViewFinishedProducts : Page
    {
        private MaterialEntities dbContext;

        public PageViewFinishedProducts()
        {
            InitializeComponent();
        ...
        {
            dgFinishedProducts.ItemsSource = dbContext.Производство.Where(p => p.Статус == "Готово").ToList();
        }
